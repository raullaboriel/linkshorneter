        ...
        <div className='container center'>
            <form onSubmit={e => signUp(e)} className='d-flex flex-column form rounded-lg'>
                <div className='row text-left justify-content-center mt-1 mb-1'>
                    <div className='col'>
                        <input onChange={e => handleDataChange(e)} value={data.username} placeholder='Nombre de usuario' name='username' required style={{ 'backgroundColor': 'rgb(58,59,61)', 'fontWeight': 'bold' }}
