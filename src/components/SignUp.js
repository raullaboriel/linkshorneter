...
const SignUp = () => {
  ...
  const signUp = async (e) => {
    ...
    if (isDataValid.username && isDataValid.email && isDataValid.password) {
      await axios.post(origin() + "/user", user).then(() => {
        setSignedUp(true);
      });
    }
  };
  ...
  return (
    <div className="container center">
      <form
        onSubmit={(e) => signUp(e)}
        className="d-flex flex-column form rounded-lg"
      >
                ...
                <div className="row text-left justify-content-center">
                  <div className="col position-sticky">
                    <span className="text-success">
                      <small className="font-weight-bold">¡Se ve bien!</small>
                    </span>
                  </div>
                </div>
              )
            ...
            {!isDataValid.email ? (
              <div className="row text-left justify-content-center">
                <div className="col position-sticky">
                  <span className="text-danger">
                    <small className="font-weight-bold">
                      Este correo no esta disponible
                    </small>
                  </span>
                </div>
              </div>
        ...
        <div className="row text-left justify-content-center mt-1 mb-1">
          <div className="col">
            <input
              ...
              style={{ backgroundColor: "rgb(58,59,61)", fontWeight: "bold" }}
              className={`form-control ${
                !isDataValid.password && data.password !== ""
                  ? "border-danger"
                  : data.password !== ""
                  ? "border-success"
                  : "border-0"
        ...
        <div className="row text-left justify-content-center mt-1 mb-1">
          <div className="col">
            <input
              ...
              style={{ backgroundColor: "rgb(58,59,61)", fontWeight: "bold" }}
              className={`form-control ${
                !isDataValid.password && data.confirmPassword !== ""
                  ? "border-danger"
        ...
        <div className="row justify-content-center mt-1">
          <div className="col">
            <button
              ...
              className="form-control border-0 text-white font-weight-bold"
              type="submit"
            >
              Registrarte
            </button>
