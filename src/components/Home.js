                ...
                <div className="d-flex flex-row mb-4">
                    <form className="col" onSubmit={(e) => onShortLink(e)}>
                        <div className="row justify-content-center flex-nowrap">
                            <input style={{ 'backgroundColor': 'rgb(58,59,61)', 'fontWeight': 'bold' }}
                                autoComplete="off" type="text" name='link' autoCorrect="off" autoCapitalize="none"
                                onChange={(e) => handleInputChange(e)} value={link}
                                ...
                                placeholder="Ingresa tu enlace" />
                            {
                                showShortenURL ?
                                    <button type="submit"
                                        ...
                                        className="btn border-0 col-lg-3 col-md-3 col-sm-3 col-xl-3x col-4 font-weight-bold btn-primary">
                                        Recortar
                                    </button>
                                    :
                                    <button
                                        ...
                                        style={{ 'backgroundColor': 'rgb(79,70,229)', 'fontSize': '18px' }}
                                        className={`btn pb-3 pt-3 border-0 col-lg-3 col-md-3 col-sm-3 col-xl col-4 font-weight-bold btn-primary ${isLinkCopied ? 'border-succes border-lg' : 'border-0'} ${isLinkCopied && 'border-success'}`}
                                    >
